...
def _build_report_markdown(item: NewsItemResponse) -> str:
    ...
    lines.append(f"**Source:** IntelPulse Cyber News Intelligence")
    lines.append("")
    lines.append("---")
    lines.append("")
    ...
    lines.append("")
    lines.append("*This report was auto-generated by IntelPulse Cyber News Intelligence. AI-enriched analysis may contain inferences based on threat intelligence knowledge.*")
...
<title>IntelPulse Report — {h(item.headline)}</title>
<style>
...
<div class="container">
<div class="classification">▪ TLP:GREEN ▪ IntelPulse INTELLIGENCE REPORT ▪ {now} ▪</div>
<div class="header">
...
<p>Auto-generated by IntelPulse Cyber News Intelligence. AI-enriched analysis may contain inferences.</p>
</div>
</div></body></html>'''
...
def _build_report_pdf(item: NewsItemResponse) -> bytes:
    ...
    story.append(Paragraph(f"▪ TLP:GREEN &nbsp;&nbsp;|&nbsp;&nbsp; IntelPulse INTELLIGENCE REPORT &nbsp;&nbsp;|&nbsp;&nbsp; {now} ▪", s_center))
    ...
    story.append(Paragraph("Auto-generated by IntelPulse Cyber News Intelligence. AI-enriched analysis may contain inferences.", s_small))
...
async def generate_news_report(
    ...
    if format == "html":
        ...
        return Response(
            ...
            headers={
                "Content-Disposition": f'attachment; filename="IntelPulse-Report-{safe_title}.html"',
            },
        )
    elif format == "pdf":
        ...
        return Response(
            ...
            headers={
                "Content-Disposition": f'attachment; filename="IntelPulse-Report-{safe_title}.pdf"',
            },
        )
    else:
        ...
        return Response(
            ...
            headers={
                "Content-Disposition": f'attachment; filename="IntelPulse-Report-{safe_title}.md"',
            },
        )
